...
OWNER_ID = int(getenv("OWNER_ID", 190190547))
...
CHANNEL_LINK = getenv("CHANNEL_LINK", "https://t.me/loveu0")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/loveu0")
